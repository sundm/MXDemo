...
public class deviceFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final GlobalData data = GlobalData.getInstance(getActivity().getApplicationContext());// (GlobalData)
																								// getActivity().getApplication();
		View view = null;
		if (data.isNFCMethod()) {
			view = inflater.inflate(R.layout.frag_device_nfc, null);
			onBoundBtn = (Button) view.findViewById(R.id.setMethod);
			...
			onSetMethodBtn = (Button) view.findViewById(R.id.setBound);
			onSetMethodBtn.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {

					// Fragment newContent = new deviceListFragment();
